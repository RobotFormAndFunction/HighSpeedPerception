...
// define motor pins 
const int A_input_0 = D0;

const int A_input_1 = D1;

const int B_input_0 = D2;

const int B_input_1 = D3;


void setup() {

  // set mode of pins to be digital outputs 
  pinMode(A_input_0, OUTPUT);
  pinMode(A_input_1, OUTPUT);
  pinMode(B_input_0, OUTPUT);
